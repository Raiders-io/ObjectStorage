...
const routes = {
  ...
  'storage.objects.listObjects': {
    ...
    tokens: [
      { old: '/storage/objects', type: 0, val: 'storage', end: '' },
      { old: '/storage/objects', type: 0, val: 'objects', end: '' },
    ],
  ...
  'storage.objects.getObject': {
    ...
    tokens: [
      { old: '/storage/objects/:id', type: 0, val: 'storage', end: '' },
      { old: '/storage/objects/:id', type: 0, val: 'objects', end: '' },
      { old: '/storage/objects/:id', type: 1, val: 'id', end: '' },
    ],
